...
Доступна функция периодической смены пароля - каждые 30 дней система будет предлагать смену текущего пароля. Управление осуществляется чекбокосом: 

**<input type="checkbox" id="period" name="period" checked>  <label for="period">Периодически менять пароль.</label>**

### Контактные данные

**Номер телефона/e-mail** обязательный элемент профиля. В зависимотси от настроек безопастности, на указанный **номер телефона/e-mail** будут приходить однразовые пароли для подверждения операций.
