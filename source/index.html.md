...
В профиле вы можете изменить пароль, контактные данные, выбрать нужную рассылку.
<aside class="notice">
...
Вы можете самостоятельно изменить пароль, для этого перейдите в профиль и установите новый пароль для Вашей учетной записи. 
Доступна функция периодической смены пароля - каждве 30 дней система будет предлагать смену текущего пароля. Управление осуществляется чекбокосом: 

**<input type="checkbox" id="period" name="period" checked>  <label for="period">Периодически менять пароль.</label>**

### Контактные данные

**Номер телефона/e-mail** обязательный элемент профиля - по ним 

### Рассылки

Вы можете выбрать тип рассылки. Управление осуществляется чекбоксами.

* Информационнуая рассылка от Банка о проводящихся работах, новом функционале и т.п.:
...
* Ежедневно получать статистику по прошедшим транзакциям за предыдущие сутки:

>**<input type="checkbox" id="stat" name="stat">  <label for="stat">Отправлять ежедневную статистику</label>**

*  Если до обработчика не были доставлены нотификации, то на указанный e-mail придет письмо, содержащее код ошибки и полный текст нотификации. Подробнее о нотификациях можно прочитать [тут](./#webhook):
