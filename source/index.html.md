...
Вы можете установить автоматическую смену пароля - после прошествия 30 дней система предложит изменить пароль к ЛК. Управление функцией осуществляется чекбокосом: 

**<input type="checkbox" id="scales" name="scales" checked>  <label for="scales">v2 Периодически менять пароль.</label>**
