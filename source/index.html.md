...
##Настройки профиля
> ![Настройки профиля](./images/proh_lk.png)

В разделе **Мой аккаунт** > **Профиль** можно изменить пароль, а так-же указать контактные данные (номер телефона/e-mail) которые будут использоваться для обратной связи.
...
- **Уведомлять при ошибках нотификаций по E-mail** - если по каким-либо транзакциям до обработчика не были доставлены нотификации, то на указанный e-mail придет письмо, содержащее код ошибки и полный текст нотификации. Подробнее о нотификациях можно прочитать [тут]( Я согласен получать на свой E-mail информационную рассылку системы АО «РФИ Банк» - если хотите получать информационную рассылку от РФИ БАНКа о проводящихся работах, новом функционал и т.п. Подробнее о нотификациях и обработчике можно прочитать [тут](./#webhook)
