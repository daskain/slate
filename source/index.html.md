...
> ![Смена пароля](./images/property_lk_pass1.png)

В разделе **Мой аккаунт** > **Профиль** можно изменить пароль и установить автоматическую смену пароля. После прошествия 30 дней система предложит имзенить пароль к ЛК.
###Контактные данные
> Настройка профиля

> ![Настройки профиля](./images/property_lk_contact.png)

Вы можете указать контактные указать контактные данные (номер телефона/e-mail) которые будут использоваться для обратной связи.
> ![Дополнительная информация](./images/property_lk_other.png)
...
> ![Добавление нового сервиса в *A1lite*](./images/service_add1.png)
