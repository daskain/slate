...
В профиле вы можете изменить пароль, контактные данные, выбрать рассылку
<aside class="notice">
        Расположение: **Мой аккаунт** → **Профиль**
    </aside>

Периодическая смена пароля - после прошествия 30 дней система предложит изменить пароль. Управление функцией осуществляется чекбокосом: 

**<input type="checkbox" id="period" name="period" checked>  <label for="period">Периодически менять пароль.</label>**

**Контактные данные** (номер телефона/e-mail) обязательный элемент профиля - по ним 

### Рассылки

Управление рассылками осуществляеться чекбоксами:
