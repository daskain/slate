...
Добро пожаловать на главную страницу технической документации РФИ Банка. Здесь представлена информация об инструментах, которые повзоляют взамиодействовать системам клиента и Банка.
Если в процессе интеграции у вас возникнут вопросы, на которые вы не сможете найти ответы в данных статьях - наши специалисты вам помогут.

## Терминология

**Банк** - АО "РФИ Банк".
**ЛК** - личный кабинет интернет эквайринга.
...
# Личный кабинет
Личный кабинет - это интерфейс, в котором собрны инструменты, которые предназанчены как для управления, так и для мониторинга работы сервисов.
