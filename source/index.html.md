...
1. Отсортировать параметры по имени в кодировке **Utf-8**, сравнивая побайтово. Параметры берутся из GET URI или из тела POST запроса (когда Content­Type равен application/x­www­form­urlencoded)
