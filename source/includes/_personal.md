...
Доступ в <a href='https://home.rficb.ru/'>ЛК</a> осуществляется по логину и паролю, которые можно получить в процессе интеграции или создать самостоятельно (на странице <a href='https://home.rficb.ru/' target="_blank">входа/регистрации</a>).
